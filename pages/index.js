...
export default function Home() {
  return (
    <div className="container">
      <Head>
        <title>Privacy Policy - Sayunara</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main>
        <Header title="Privacy Policy" />
        <div className="description" style={{ textAlign: 'left', maxWidth: 800, margin: '0 auto' }}>
          <h2>Privacy Policy</h2>
          <p>
            Sayunara dev built the Sayunara app as a Free app. This SERVICE is provided by Sayunara dev at no cost
          ...
          <p>
            ...
            accessible at Sayunara unless otherwise defined in this Privacy Policy.
          </p>
          ...
          <p>
            ...
            <br />
            <a href="mailto:sayunarabelanjaonline@gmail.com">
              sayunarabelanjaonline@gmail.com
            </a>
          </p>
        </div>
      </main>
